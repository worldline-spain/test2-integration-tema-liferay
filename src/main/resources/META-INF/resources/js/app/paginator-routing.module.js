...
define(["require", "exports", "@angular/core", "@angular/router", "./app.component"], function (require, exports, core_1, router_1, app_component_1) {
    ...
    var PaginatorRoutingModule = (function () {
        function PaginatorRoutingModule() {
        }
        return PaginatorRoutingModule;
    }());
    PaginatorRoutingModule = __decorate([
        core_1.NgModule({
            imports: [
    ...
    exports.PaginatorRoutingModule = PaginatorRoutingModule;
});
//# sourceMappingURL=paginator-routing.module.js.map